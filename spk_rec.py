...
train_path="data/spk_rec_data/train/"
test_path="data/spk_rec_data/test/"
...
for i in range(0,len(language_files)):
	...
	gmm.append(GaussianMixture(n_components=10,covariance_type='full',max_iter=20, random_state=None))  #training the models
	gmm[i].fit(mfcc_temp)
